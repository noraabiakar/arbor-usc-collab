...
for ii in range(num_input):
    ...
    neuron_DG.synGroups['AMPA']['soma'][0].tau1 = in_param["tau1_syn"]
    neuron_DG.synGroups['AMPA']['soma'][0].tau2 = in_param["tau2_syn"]
    neuron_DG.synGroups['AMPA']['soma'][0].e = in_param["e_syn"]
